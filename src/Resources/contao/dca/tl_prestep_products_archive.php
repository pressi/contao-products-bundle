 ...
 */
$GLOBALS['TL_DCA']['tl_prestep_products_archive'] = array
(
	...
	(
		'dataContainer'               => 'Table',
		'ctable'                      => array('tl_prestep_product'),
		'switchToEdit'                => true,
		'enableVersioning'            => true,
		'onload_callback' => array
		(
			array( 'tl_prestep_products_archive', 'checkPermission'),
			array( 'tl_prestep_products_archive', 'generateFeed')
		),
		'onsubmit_callback' => array
		(
			array( 'tl_prestep_products_archive', 'scheduleUpdate')
		),
		'sql' => array
		(
			'keys' => array
...
//			'feeds' => array
//			(
//				'label'               => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['feeds'],
//				'href'                => 'table=tl_news_feed',
//				'class'               => 'header_rss',
//				'attributes'          => 'onclick="Backend.getScrollOffset()"',
//				'button_callback'     => array( 'tl_prestep_products_archive', 'manageFeeds')
//			),
			'all' => array
			(
		...
		(
			...
			'editheader' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['editheader'],
				'href'                => 'act=edit',
				'icon'                => 'header.svg',
				'button_callback'     => array( 'tl_prestep_products_archive', 'editHeader')
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['copy'],
				'href'                => 'act=copy',
				'icon'                => 'copy.svg',
				'button_callback'     => array( 'tl_prestep_products_archive', 'copyArchive')
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.svg',
				'attributes'          => 'onclick="if(!confirm(\'' . $GLOBALS['TL_LANG']['MSC']['deleteConfirm'] . '\'))return false;Backend.getScrollOffset()"',
				'button_callback'     => array( 'tl_prestep_products_archive', 'deleteArchive')
			),
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.svg'
			)
		)
	...
	(
		...
		'title' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['title'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
		...
		'jumpTo' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['jumpTo'],
			'exclude'                 => true,
			'inputType'               => 'pageTree',
		...
		'protected' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['protected'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'checkbox',
		...
		'groups' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['groups'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
		...
		'allowComments' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['allowComments'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('submitOnChange'=>true),
		...
		'notify' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['notify'],
			'default'                 => 'notify_admin',
			'exclude'                 => true,
			'inputType'               => 'select',
			'options'                 => array('notify_admin', 'notify_author', 'notify_both'),
			'eval'                    => array('tl_class'=>'w50'),
			'reference'               => &$GLOBALS['TL_LANG']['tl_prestep_products_archive'],
			'sql'                     => "varchar(16) NOT NULL default ''"
		),
		'sortOrder' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['sortOrder'],
			'default'                 => 'ascending',
			'exclude'                 => true,
			'inputType'               => 'select',
		...
		'perPage' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['perPage'],
			'exclude'                 => true,
			'inputType'               => 'text',
		...
		'moderate' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['moderate'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'w50'),
			'sql'                     => "char(1) NOT NULL default ''"
		...
		'bbcode' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['bbcode'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'w50'),
			'sql'                     => "char(1) NOT NULL default ''"
		...
		'requireLogin' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['requireLogin'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'w50'),
			'sql'                     => "char(1) NOT NULL default ''"
		...
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_prestep_products_archive']['disableCaptcha'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'w50'),
			'sql'                     => "char(1) NOT NULL default ''"
 ...
 */
class tl_prestep_products_archive extends Backend
{
	...
	public function checkPermission()
	{
		...
		{
			unset($GLOBALS['TL_DCA']['tl_prestep_products_archive']['fields']['allowComments']);
		}
		...
		$GLOBALS['TL_DCA']['tl_prestep_products_archive']['list']['sorting']['root'] = $root;

		// Check permissions to add archives
		if (!$this->User->hasAccess('create', 'newp'))
		{
			$GLOBALS['TL_DCA']['tl_prestep_products_archive']['config']['closed'] = true;
		}
		...
		switch (Input::get('act'))
		{
			...
			case 'edit':
				...
				if (!\in_array(Input::get('id'), $root))
				{
					...
					if (\is_array($arrNew['tl_prestep_products_archive']) && \in_array(Input::get('id'), $arrNew['tl_prestep_products_archive']))
					{
	...
	{
		return $this->User->canEditFieldsOf( 'tl_prestep_products_archive' ) ? '<a href="'.$this->addToUrl($href.'&amp;id='.$row['id']).'" title="'.StringUtil::specialchars($title).'"'.$attributes.'>'.Image::getHtml($icon, $label).'</a> ' : Image::getHtml(preg_replace('/\.svg$/i', '_.svg', $icon)).' ';
	}
